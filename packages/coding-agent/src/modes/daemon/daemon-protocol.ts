...
// Revision 17 adds the set_kernel_cwd command and kernel_cwd_propagation capability.
// Revision 18 gates authoritative child rosters and transient owned-session recovery context.
// Revision 19 adds the opt-in RLM quiescence barrier to headless completion.
// Revision 20 adds daemon-held session input pauses.
...
export type DaemonServerCapability =
	...
	// The daemon propagates kernel-side cwd changes (from IPython %cd / os.chdir)
	// back to the client-owned footer and autocomplete. Clients must check
	// before sending set_kernel_cwd.
...
export const DAEMON_COMMAND_COMPATIBILITY = {
	...
	replace_acp_mcp_servers: { minProtocol: 7, minSchemaRevision: 23, capability: "acp_mcp_servers" },
	...
	set_kernel_cwd: { minProtocol: 7, minSchemaRevision: 17, capability: "kernel_cwd_propagation" },
